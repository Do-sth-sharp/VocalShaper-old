...
class ColorEditorCallOutBoxLAF final : public juce::LookAndFeel_V4
{
public:
	ColorEditorCallOutBoxLAF(const std::function<int()>& borderSizeFunc, const std::function<float()>& cornerSizeFunc,
	...
	~ColorEditorCallOutBoxLAF() override = default;
...
private:
	...
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(ColorEditorCallOutBoxLAF)
};