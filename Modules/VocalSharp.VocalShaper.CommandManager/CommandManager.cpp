	...
	:ApplicationCommandTarget()
{
	...
	//初始化命令列表
	this->initFileCommand();
	this->initEditCommand();
	this->initViewCommand();
	this->initModifyCommand();
	this->initProjectCommand();
	this->initTransportCommand();
	this->initAutomaticCommand();
	this->initConfigCommand();
	this->initMiscCommand();

	this->initAdsorbCommand();
...
void CommandManager::initFileCommand()
{
	this->infoList.add({
		.name = "New Project",
...
void CommandManager::initEditCommand()
{
	this->infoList.add({
		.name = "Undo",
...
void CommandManager::initViewCommand()
{
	this->infoList.add({
...
void CommandManager::initAutomaticCommand()
{

}

void CommandManager::initConfigCommand()
{

}

void CommandManager::initMiscCommand()
{

}

void CommandManager::initAdsorbCommand()
{
	this->infoList.add({
		.name = "Adsorb 1 Beat",
...
void CommandManager::initGridCommand()
{
	this->infoList.add({
		.name = "Grid 1 Beat",
